...
import com.nilapps.batteryalarm.util.FlashlightProvider;
...
public class AlarmService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            if (intent.getStringExtra("OPEN_ACTIVITY").equalsIgnoreCase("ENTERPIN")) {
        ...
        if (intent != null && intent.getStringExtra("OPEN_ACTIVITY").equalsIgnoreCase("ENTERPIN")) {
            playSiren();
        }
        else {
            playMusic();
    ...
    private void playMusic() {
        ...
        mp.setLooping(true);
        try {
            mp.setDataSource(this, Uri.parse("android.resource://com.nilapps.batteryalarm/" + sound));
            mp.prepare();
        } catch (IOException e) {
            e.printStackTrace();
        }
